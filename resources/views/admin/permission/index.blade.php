...
@section('content')
    ...
    <div class="layui-fluid">
        <button class="layui-btn-group ">
            ...
            <a class="layui-btn layui-btn-sm" href="{{ route('admin.permission.create') }}"><i class="layui-icon">&#xe654;</i>添 加</a>
            @endcan
        </button>
        <table id="dataTable" lay-filter="dataTable"></table>
        <script type="text/html" id="options">
            @can('system.permission')
            <a class="layui-btn layui-btn-sm" lay-event="children"><i class="layui-icon">&#xe614;</i>子权限</a>
            @endcan
